...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('C:/Users/SRAVA/OneDrive/Desktop/Sravanth personal/chatbot_modelsave','rb'))
model,second_le  = pk.load(open('C:/Users/SRAVA/OneDrive/Desktop/Sravanth personal/chatbot_model','rb'))
#ners = pk.load(open("D:\HealthCare_ChatBot-master\modeltraing_googleclob",'rb'))

# Load NN Model 
FILE = "C:/Users/SRAVA/OneDrive/Desktop/Sravanth personal/data.pth"
